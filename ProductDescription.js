...
export default function ProductDescription({product,setProduct}) {
    ...
    useEffect(()=>{
       ...
       /*var data=[{productname:'Maaza', productdetailname:'Maaza Mango Drink ', weight:250, weighttype:'gm', packagingtype:'1', noofqty:'1', stock:5, price:99, 
...
{productname:'String', productdetailname:'Strings Energy Drink', weight:250, weighttype:'gm', packagingtype:'1', noofqty:'1', stock:5, price:99, 
         offerprice:80, offertype:'Festival', productstatus:'Trending', picture:'string.jpg'},
{productname:'Vim', productdetailname:'Vim Lemon Concentrated Dishwash', weight:250, weighttype:'gm', packagingtype:'1', noofqty:'1', stock:5, price:99, 
           offerprice:80, offertype:'Festival', productstatus:'Trending', picture:'vim.webp'},
{productname:'Lays', productdetailname:'Lays American Style Cream and Onion Potato Chips', weight:250, weighttype:'gm', packagingtype:'1', noofqty:'1', stock:5, price:99, 
          offerprice:80, offertype:'Festival', productstatus:'Trending', picture:'lays.webp'},
{productname:'Munch', productdetailname:'Munch Choclate', weight:250, weighttype:'gm', packagingtype:'1', noofqty:'1', stock:5, price:99, 
...
{productname:'Hide & Seek', productdetailname:'Parle Hide & Seek Biscuits', weight:250, weighttype:'gm', packagingtype:'1', noofqty:'1', stock:5, price:99, 
            offerprice:80, offertype:'Festival', productstatus:'Trending', picture:'hide&seek.webp'},
{productname:'Tata Tea', productdetailname:'Tata Tea Premium', weight:250, weighttype:'gm', packagingtype:'1', noofqty:'1', stock:5, price:99, 
