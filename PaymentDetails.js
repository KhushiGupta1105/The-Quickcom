...
export default function PaymentDetails({refresh,setRefresh}){
    ...
    console.log("USEEER DATTTTA:",userData)
    ...
    const addressView=()=>{
        return(
            <div>
                <Paper style={{width:380, height:650, borderRadius:15, justifySelf:'right'}}>
                    <div style={{marginLeft:25}}>
                        ...
                        <Grid container spacing={1}>
                            ...
                            <Grid item xs={12} style={{width:'90%', marginTop:5}}>
                                <TextField onChange={(e)=>setLandmark(e.target.value)} label="Landmark" variant="standard" fullWidth/>
                            </Grid>
                            ...
                            <Grid item xs={12}>
                                <Button onClick={handleSubmitAddress} style={{borderRadius:25, height:53, marginTop:10, color:'#fff', background:'#0078ad', fontFamily:'JioType, helvetica, arial, sans-serif', fontWeight:700, fontSize:14, letterSpacing:-0.07, lineHeight:1.4285714286, width:'95%'}} fullWidth>
                                    Save and Proceed
                                </Button>
                            </Grid>
                        </Grid>
                ...
                <Paper style={{width:300, height:250, borderRadius:15, justifySelf:'right', marginTop:40}}>
        ...
        <div style={{fontFamily:'JioType, helvetica, arial, sans-serif',fontWeight:900,fontSize:'1rem',letterSpacing:-0.72,lineHeight: 1.25,marginLeft:28,marginBottom:20,marginTop:20}}>
            Payment Details
                    ...
                    <div style={{display:'flex', marginTop:15, marginBottom:10, justifyContent:"space-between"}}>
                        ...
                        <div style={{color:'rgba(0,0,0,.65)', fontFamily:'JioType, helvetica, arial, sans-serif', fontWeight:700, fontSize:'1rem', letterSpacing:-0.07, lineHeight:1.4285714286, marginRight:20}}>
              ...
              <Button style={{border:'1px solid #ddd', borderRadius:25, width:matches?'91%':'93%', height:53, marginTop:10, color:'#fff', background:'#0078ad', fontFamily:'JioType, helvetica, arial, sans-serif', fontWeight:700,
                fontSize:14, letterSpacing:-0.07, lineHeight:1.4285714286}} onClick={handlePlaceOrder} fullWidth>{btnTxt}</Button>
            </div>
