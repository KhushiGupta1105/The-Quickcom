...
return(<div style={{position:'relative'}} >
    ...
    {matches?<div onClick={handleNext} style={{position:'absolute',zIndex:2,top:'43%',left:'0.8%',background:'#b2bec3',opacity:0.5,width:30,height:30,borderRadius:15,display:'flex',alignItems:'center',justifyContent:'center'}}>
