...
export default function ProductDetailPage()
{
    ...
    return(
       ...
       <Grid container>
        ...
        <div style={{backgroundColor:'#f5f6fa', borderRadius:40, border:'1px #f5f6fa', marginBottom:8, marginLeft:100, width:'83%',
            height:6, marginTop:30
        }}></div>
