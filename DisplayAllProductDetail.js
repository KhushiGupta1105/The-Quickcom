          ...
          <MaterialTable
            ...
            columns={[
              ...
              { title: "Id's",
                render: (rowData) => (
                  <div style={{ display: "flex", flexDirection: "column" }}>
                    <div>{rowData.categoryname}/
                    {rowData.subcategoryname}</div>
                    <div>{rowData.brandname}/
              ...
              { title: "About",
                render: (rowData) => (
                  <div style={{ display: "flex", flexDirection: "column", fontSize:10 }}>
                    ...
                    <div>{rowData.packagingtype}[{rowData.noofqty}]</div>
                    <div>Stock:{rowData.stock}</div>
                    <div><s>{rowData.price}</s> {rowData.offerprice}</div>
                    <div>{rowData.offertype}/
                    {rowData.productstatus}</div>
                  </div>
                ),
              },
